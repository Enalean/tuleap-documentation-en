...
A new plugin :ref:`OAuth2 and OpenIDConnect Provider <openidconnect_provider>` (Tuleap Enterprise only) is available. You should run the following command if you need to install it.

.. code-block:: bash

    $ yum install tuleap-plugin-oauth2-server
