...
::
  ...
  MyTuleapProject > Trackers > MyTracker > Submit new artifact

To submit a new artifact to a given project you must first access the
appropriate tracker of that project as indicated in the previous section
:doc:`entering-the-tracker-service`

When entering a given tracker you are presented with the artifact
selection and browsing screen (more about this facility in :doc:`search-for-existing-artifacts`).
For now let's click on the "Submit new artifact" item (or whatever the artifact
name is) from the Tracker Menu Bar in the upper part of the welcome
screen (see :ref:`services_trackers_a-tracker-browsing-screen`).

.. figure:: ../../../../images/services/trackers/entering-the-tracker-service/sc_artifactsubmission_new.png
   :align: center
