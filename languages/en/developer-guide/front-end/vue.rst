...
Here you will find some guidelines explaining how you have to process to build up you application.
...
.. code-block:: bash
    ...
    npm run watch    # Run the Karma unit tests and build the app in watch mode in the same time.
...
To allow your app to run in Tuleap, you may need to create a mount in a mustache template.
...
.. code-block:: JavaScript
    ...
    import Vue      from 'vue';
    import MyVueApp from './src/MyVueApp.vue';
